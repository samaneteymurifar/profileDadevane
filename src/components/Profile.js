...
function Profile(){
     return(
        ...
        <div>
            ...
            <ReactLogo className='profileLogo'/>
            </div>
            <form>
                ...
                <div className='formBox'>
                    <div className='inputBox'>
                        <span for='mobileNumber'>شماره موبایل</span>
                        <input type='text' id='mobileNumber' placeholder='09123334455' readOnly></input>
                    </div>



                    <div className='inputBox'>
                        <span for='ageYear'>سال تولد</span>
                        <input type='text' id='ageYear' placeholder='1371' readOnly ></input>
                        <label for='ageYear' onClick={console.log('hgd')}>
                    ...
                    <div className='inputBox'>
                        <span for='gender'>جنسیت</span>
                        <input type='text' id='gender' placeholder='خانم' readOnly></input>
                        <label for='gender' onClick={console.log('hgd')}>
                        <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0 10.0938V12.75H2.83582L11.1996 4.91583L8.36378 2.25958L0 10.0938ZM2.20816 11.3333H1.51244V10.6817L8.36378 4.26417L9.0595 4.91583L2.20816 11.3333ZM13.3926 1.86292L11.6231 0.205417C11.4718 0.06375 11.2828 0 11.0862 0C10.8896 0 10.7005 0.0708333 10.5568 0.205417L9.17294 1.50167L12.0088 4.15792L13.3926 2.86167C13.6876 2.58542 13.6876 2.13917 13.3926 1.86292Z" fill="#FE7A30"/>
                        </svg>
                        </label>
            ...
            <button onClick={()=>console.log('test')}> ذخیره تغییرات </button>
            </div>
            <div className='contentFooter'>
            <div id='contentFooterGrade'>
